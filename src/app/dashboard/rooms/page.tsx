    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-lg shadow p-6 text-center">
          <p className="text-gray-700 mb-4">No examination rooms have been added yet.</p>
          <button
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {rooms.map((room) => (
                  <tr key={room._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      {typeof room.floor === 'number' ? room.floor : '-'}
                    </td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-right">
                      <button
                        ...
                        className={room.isActive ? "text-yellow-600 hover:text-yellow-900" : "text-green-600 hover:text-green-900"}
                      >
        ...
        <div className="bg-gray-50 rounded-lg p-4 shadow-sm">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <p className="text-xl font-semibold">{rooms.filter(r => r.isActive).length}</p>
            </div>
            <div>
              <p className="text-sm text-gray-500">Total Capacity</p>
              <p className="text-xl font-semibold">{rooms.reduce((sum, room) => sum + room.capacity, 0)} seats</p>
            </div>
            <div>
              <p className="text-sm text-gray-500">Active Capacity</p>
              <p className="text-xl font-semibold">{rooms.filter(r => r.isActive).reduce((sum, room) => sum + room.capacity, 0)} seats</p>
            </div>
          </div>
        </div>
      )}
