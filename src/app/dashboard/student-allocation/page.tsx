...
export default function StudentAllocation() {
  ...
  const handleAllocate = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/allocate-students', {
        method: 'POST',
        headers: {
      ...
      if (!response.ok) {
        throw new Error(data.error || 'Failed to allocate students');
      }
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        {result && (
          <div className="mt-4 p-4 bg-green-50 text-green-700 rounded-md">
            ...
            <div className="mt-4">
              <Link href="/dashboard/reports/student-seating" className="text-purple-600 hover:underline">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="space-y-3 text-gray-600">
          ...
          <ol className="list-decimal list-inside space-y-2 ml-4">
            ...
            <li>Splits sections across rooms only when needed</li>
            <li>Sorts students by USN within each section for easy identification</li>
            <li>Creates seat numbers for organized seating arrangements</li>
          </ol>
        </div>
      </div>
    </div>
